...
module.exports = function buildUrl(accum, config, method, arg1, arg2, ...args) {
	...
	const { body, query, rest = [] } = config.argInterceptor ? config.argInterceptor(arg1, arg2, ...args) : endpoint.getPayloads(arg1, arg2)
